...
export const metadata: Metadata = { title: '期刊卷期｜客家與數位人文期刊', description: '閱讀及引用已正式出版的客家歷史、語言、社會、文化與數位人文研究。' };
