...
export type Submission = { id: string; title: string; titleEn: string | null; authorName: string; abstract: string; abstractEn: string | null; keywords: string | null; status: string; articleBody: string; pages: string | null; doi: string | null; issueId: string | null; editorNotes: string; reviewCount: number; averageScore: number | null; createdAt: string };
