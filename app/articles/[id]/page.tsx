...
type Article = { id: string; title: string; titleEn: string | null; authorName: string; affiliation: string | null; category: string; abstract: string; abstractEn: string | null; keywords: string | null; articleBody: string; pages: string | null; doi: string | null; finalName: string | null; publishedAt: string; volume: number; number: number; year: number; issueTitle: string };
