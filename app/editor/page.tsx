...
export default async function EditorPage() {
  ...
  const [submissions, issues, members] = await Promise.all([
    query<Omit<Submission, 'createdAt'> & { createdAt: Date | string }>(`SELECT s.id, s.title, s.title_en AS "titleEn", s.author_name AS "authorName", s.author_email AS "authorEmail", s.abstract,
      ...
      s.submission_channel AS "submissionChannel",
